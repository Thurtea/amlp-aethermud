...
void create() {
    ...
    set_race_description(
        "Placeholder: Add full race description for ${display_name}."
    );
    
    // Placeholder: configure physical characteristics
    set_size_category(SIZE_MEDIUM);
    set_height_range(60, 72);
    set_weight_range(120, 200);
    set_lifespan(80);
    
    // Placeholder: configure stat modifiers
    set_stat_modifiers(([
        // Example: "ps": 2
    ]));
    
    // Placeholder: configure racial abilities
    set_racial_abilities(({ }));
    
    // Placeholder: configure OCC restrictions
    set_allowed_occs(({ }));
    set_forbidden_occs(({ }));
    set_recommended_occs(({ }));
    
    // Placeholder: configure starting resources
...
void create() {
    ...
    set_occ_description(
        "Placeholder: Add full O.C.C. description for ${display_name}."
    );
    
    // Placeholder: configure stat requirements
    set_stat_requirements(([
        // Example: "iq": 10
    ]));
    
    // Placeholder: configure stat bonuses
    set_stat_bonuses(([
        // Example: "ps": 2
    ]));
    ...
    // Placeholder: configure OCC skills
    set_occ_skills(({
        "language_american"
    }));
    ...
    // Placeholder: configure starting equipment
