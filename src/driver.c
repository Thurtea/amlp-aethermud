...
#undef MAX_HELP_TOPICS
    ...
    /* Admin commands */
    /* NOTE: "promote" is handled entirely by lib/cmds/admin/promote.lpc via the
     * LPC command daemon.  The old C-side handler (levels 0-2 only) has been
     * removed so promote.lpc can handle all five levels (0-4) with role names. */
